...
template <> constexpr inline auto Register::qt_create_metaobjectdata<qt_meta_tag_ZN8RegisterE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'sigRegisterYes'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'sigSwitchLogin'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'on_get_verify_clicked'
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sigRegisterYes(); break;
        case 1: _t->sigSwitchLogin(); break;
        case 2: _t->on_get_verify_clicked(); break;
        case 3: _t->slot_req_mod_finish((*reinterpret_cast<std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<ErrorCodes>>(_a[3]))); break;
        case 4: _t->on_yes_btn_clicked(); break;
        case 5: _t->on_no_btn_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::sigRegisterYes, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::sigSwitchLogin, 1))
            return;
    }
}
